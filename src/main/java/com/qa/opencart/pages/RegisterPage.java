...
public class RegisterPage {
	...
	private By confirmePassword = By.id("input-confirm");
	...
	public boolean userRegister(String firstName, String lastName,String emailId, String telephone, String password, 
			String subscribe) {
		...
		eleUtil.doSendKeys(this.confirmePassword, password);
